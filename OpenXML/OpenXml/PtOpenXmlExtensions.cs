...
namespace OpenXML
{
    ...
    public static class S
    {
        ...
        public static XName customWidth = s + "customWidth";
        ...
        public static XName max = s + "max";
        public static XName min = s + "min";
        ...
        public static XName uniqueCount = s + "uniqueCount";
        public static XName v = s + "v";
        public static XName vertical = s + "vertical";
        public static XName width = s + "width";
