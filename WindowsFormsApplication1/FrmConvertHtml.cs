...
namespace WindowsFormsApplication1
{
    public partial class FrmConvertHtml : Form
    {
        ...
        //        private static object ConvertToHtmlTransform(WordprocessingDocument wordDoc, HtmlConverterSettings settings, XNode node, Func<ImageInfo, XElement> imageHandler)
        //        {
        ...
        //        public IEnumerable<XElement> LogicalChildrenContent(XElement element, XName name)
        //        {
        //            return element.LogicalChildrenContent().Where(e => e.Name == name);
        //        }

        //        public IEnumerable<XElement> DescendantsTrimmed(XElement element, XName trimName)
        //        {
        //            return DescendantsTrimmed(element, e => e.Name == trimName);
        //        }

        //        public IEnumerable<XElement> DescendantsTrimmed(XElement element, Func<XElement, bool> predicate)
        //        {
        ...
        //        public IEnumerable<XElement> LogicalChildrenContent(XElement element)
        //        {
        //            if (element.Name == W.document)
        ...
        //    //{
        //    //    byte[] byteArray = File.ReadAllBytes("c:\\users\\tamerpc\\desktop\\serdar\\hello.docx");
        ...
        //    //                foreach (var item in wordDoc.MainDocumentPart.Document.ChildElements)
        //    //                {
        ...
        //    //private int m_i;
        //    //private Microsoft.Office.Interop.Word.Document docs;
        ...
        //    //    file.InitialDirectory = "c:\\users\\tamerpc\\desktop\\serdar";
        ...
        //    //        foreach(Paragraph item in docs.Paragraphs)
        //    //        {
        //    //            MessageBox.Show(item.Range.Text);
        //    //        }
        ...
        //    //protected void readword2()
        //    //{
        //    //    TextExtractor extractor = new TextExtractor("c:\\users\\tamerpc\\desktop\\serdar\\test_post_document.docx");
        ...
        //    //    foreach (InlineShape ils in docs.InlineShapes)
        //    //    {
        //    //        // validate
        //    //        if (ils != null)
        //    //        {
        //    //            // check if image
        //    //            if (ils.GetType() == WdInlineShapeType.wdInlineShapePicture.GetType())
        //    //            {
        //    //                // select the shape
        //    //                ils.Application.Selection.Select();
        ...
        //    //                        if (bmp != null)
        //    //                        {
        //    //                            MessageBox.Show("Hey! This worked!");
        //    //                        }
        //    //                        else
        //    //                        {
        //    //                            MessageBox.Show("Yea. That didn't work so well");
        //    //                        }
        //    //                    }
        //    //                }
